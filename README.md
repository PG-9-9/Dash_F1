...
strategy generation inspired by GFlowNets and SynFlowNet, and an experimental
hybrid-energy environment for the Battery tab.
...
| Strategy | Reward-shaped constrained trajectory sampling | Diverse scenario recommendations, not a trained GFlowNet |
...
- [Strategy Flow and SynFlowNet Inspiration](wiki/Strategy-Flow.md)
